        ...
        <div className={styles.productGrid}>
          ...
          <div className={styles.detailsSection}>
            ...
            <div className={styles.description}>
              ...
              <p>
                Premium quality {product.name.toLowerCase()} sourced directly
                from organic farms. Rich in nutrients and naturally processed to
                retain maximum health benefits. Perfect for daily consumption.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.containers}>
          ...
          <div className={styles.content}>
            ...
            <p>
              ...
              When farmers feel uplifted, entire communities flourish, creating
              lasting and collective wellbeing.
            </p>
